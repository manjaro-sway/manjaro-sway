/**
 * The Manjaro Sway logo, the same file docs/img/favicon.svg serves.
 *
 * Inlined rather than fetched from the assets binding: this is returned
 * before any mount is resolved, and a favicon that 404s on the listings
 * while the landing page has one is exactly the seam this page should not
 * show.
 */
